...
#define EXTENSION_NAME "omni.cae.delegate.hdf5.plugin"
...
public:
    void onStartup(const char* extId) override
    {
        ...
        // register Hdf5 data delegate
        auto hdf5Delegate = carb::stealObject<omni::cae::data::IDataDelegate>(
            new omni::cae::data::hdf5::DataDelegate(EXTENSION_NAME, utils));
        registry->registerDataDelegate(hdf5Delegate);
    }
...
const struct carb::PluginImplDesc kPluginImpl = { EXTENSION_NAME, "CAE HDF5 Data Plugin.", "NVIDIA",
