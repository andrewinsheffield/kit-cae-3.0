...
#define EXTENSION_NAME "omni.cae.delegate.openfoam.plugin"

using namespace carb;
CARB_PLUGIN_IMPL_DEPS(omni::cae::data::IDataDelegateInterface, carb::logging::ILogging, carb::tasking::ITasking);
...
public:
    void onStartup(const char* extId) override
    {
        ...
        // register OpenFOAM data delegate
        omni::cae::data::IDataDelegatePtr delegate =
            carb::stealObject<omni::cae::data::IDataDelegate>(new omni::cae::data::openfoam::DataDelegate(extId, utils));
        registry->registerDataDelegate(delegate);
    }
...
const struct carb::PluginImplDesc kPluginImpl = { EXTENSION_NAME, "CAE Data OpenFOAM Plugin.", "NVIDIA",
