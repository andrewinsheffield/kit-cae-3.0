...
- `exts."omni.cae.delegate.cgns".convertDoubleToFloats`: Enable downsampling of double precision arrays to float (default: true)
- `exts."omni.cae.delegate.cgns"convertElementConnectivityToInt32`: Enable downsampling of element connectivity arrays to int32 (default: true)
