...
`omni.cae.data` is a deprecated compatibility extension for legacy Data Delegate
workflows. Active USD-plugin based workflows should use `omni.cae.core` for
shared utilities and lazy-loading/data access through the USD plugins stack.
